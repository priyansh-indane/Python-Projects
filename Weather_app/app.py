...
com = ttk.Combobox(window,text="Weather App",values=list_name,font=("Times New Roman",20,"bold"))

com.place(x=35,y=90,height=50,width=650)

done_button = Button(window,text="Done",font=("Times New Roman",20,"bold"))
...
w_label1 = Label(window,text='t',font=("Times New Roman",25,"bold"))
...
wb_label1 = Label(window,text='t',font=("Times New Roman",25,"bold"))
...
temp_label1 = Label(window,text='t',font=("Times New Roman",25,"bold"))
...
pre_label1 = Label(window,text='t',font=("Times New Roman",25,"bold"))
